...
class PathPlanner():
  ...
  def update(self, sm, pm, CP, VM):
    ...
    below_lane_change_speed = v_ego < LANE_CHANGE_SPEED_MIN#(sm['dragonConf'].dpAssistedLcMinMph * CV.MPH_TO_MS)
    ...
    plan_send.pathPlan.dpALCAllowed = False#self.dragon_auto_lc_allowed
